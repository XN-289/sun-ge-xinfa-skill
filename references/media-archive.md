...
| 时间点 / 事件 | 成本 | 用途 | 回收 | 残留资产 | 证据层 |
|---|---|---|---|---|---|
| 2019 巴菲特午餐 | 约 457 万美元 | 买一个全球可传播的金额锚点 | 取消、补办、围观形成多波热度 | “与巴菲特吃饭”的长期叙事身份 | 公开记录 + 叙事推演 |
| 2018 收购 BitTorrent | 收购对价 + 后续整合 | 先拿注意力资产，再发 BTT 完成回收 | BTT 发行把收购话题转化为代币热度 | 品牌 + 用户底座 + 可再包装的技术故事 | 公开记录 + 叙事推演 |
| 2020 Steem/Hive | 治理接管成本 | 验证中心化控制与“去中心化”话术的落差 | 社区分裂本身成为争议流量 | “接管争议”作为长期舆论素材 | 公开记录 + 叙事推演 |
| 2022 FTX 救助喊话 | 几乎零现金承诺 | 在崩盘叙事里插入自己的宏大救市形象 | 注意力与“救市者”标签 | 未兑现/部分兑现的话术，可再讲一次 | 公开记录 + 叙事推演 |
| 2024 吃香蕉 | 约 620 万美元 | 把艺术/新闻事件变成个人流量入口 | 全网二创、中文“孙学”再加热 | “消费即内容”的可复制公式 | 公开记录 + 叙事推演 |
| 2025 WLFI 冻结 | 政治/资本关系暴露成本 | 测试“金钱钥匙”在盟友关系里的失效条件 | 争议即素材，中英文人设分叉更清晰 | “从不败叙事到双向诉讼”的反转脚本 | 公开记录；双方主张未决 |
| 2026 景甜小作文 | 私域叙事与大量未核实细节 | 把私人叙事变成大众注意力结算 | 叙事情绪、二创、流量再分配 | “纯属虚构 + 真实姓名”的可复用争议框架 | 网传文本 + 叙事推演 |

这七行是“已蒸馏事件账本”的压缩版，不是重新列新节点。逐行背后的出处分别对应
[GeminiGuy/sun-yuchen-perspective](https://github.com/GeminiGuy/sun-yuchen-perspective)
的 `01-writings.md`、`03-expression-dna.md`、`04-external-views.md`、`05-decisions.md`、
`06-timeline.md` 与 [public-record.md](public-record.md)；需要写实时状态时，仍先走
[external-search.md](external-search.md)。
